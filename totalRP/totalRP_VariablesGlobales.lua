...
soundsfiche = {
	["Human2"] = {hello = 6162, cantuseyet = 1879, cantuse = 1918,congrats = 0, notarget =1906, cantcarry = 1898},
	["Human3"] = {hello = 6134,cantuseyet = 2003,cantuse = 2042,congrats = 0, notarget =2030, cantcarry =2022},
	["Dwarf2"] = {hello = 6107, cantuseyet = 1586,cantuse = 1653,congrats = 0, notarget =1614, cantcarry =1616},
	["Dwarf3"] = {hello = 6094,cantuseyet = 1658,cantuse = 0,congrats = 0, notarget =1684, cantcarry =1677},
	["Gnome2"] = {hello = 6125,cantuseyet = 1713,cantuse = 1753,congrats = 0, notarget =1741, cantcarry =1731},
	["Gnome3"] = {hello = 6116,cantuseyet = 1768,cantuse = 1808,congrats = 0, notarget = 1796, cantcarry =1788},
	["NightElf2"] = {hello = 6180,cantuseyet = 2122,cantuse = 2161,congrats = 0, notarget =2149, cantcarry =2141},
	["NightElf3"] = {hello = 0,cantuseyet = 2233, cantuse = 2272,congrats = 0, notarget =2260, cantcarry =2252},
	["Draenei2"] = {hello = 9712,cantuseyet = 9475,cantuse = 9535,congrats = 0, notarget =9463, cantcarry =9506},
	["Draenei3"] = {hello = 9687,cantuseyet = 9476,cantuse = 9536,congrats = 0, notarget =9514, cantcarry =9507},
	["Orc2"] = {hello = 6360,cantuseyet = 2288,cantuse = 2329,congrats = 0, notarget =2317, cantcarry =2309},
	["Orc3"] = {hello = 6351,cantuseyet = 2345,cantuse = 2384,congrats = 0, notarget =2372, cantcarry =2364},
	["Troll2"] = {hello = 6396,cantuseyet = 1824,cantuse = 1863,congrats = 0, notarget =1851, cantcarry =1843},
	["Troll3"] = {hello = 6387,cantuseyet = 1934,cantuse = 1987,congrats = 0, notarget =1961, cantcarry =1953},
	["Tauren2"] = {hello = 6378,cantuseyet = 2404,cantuse = 2483,congrats = 0, notarget = 2459, cantcarry =2443},
	["Tauren3"] = {hello = 6369,cantuseyet = 2405,cantuse = 2482,congrats = 0, notarget =2458, cantcarry =2442},
	["Undead2"] = {hello = 6414,cantuseyet = 2058,cantuse = 2106,congrats = 0, notarget =2085, cantcarry =2077},
	["Undead3"] = {hello = 6405,cantuseyet = 2177,cantuse = 2217,congrats = 0, notarget =2205, cantcarry =2197},
	["BloodElf2"] = {hello = 9662,cantuseyet = 9559,cantuse = 9611,congrats = 0, notarget =9597, cantcarry =9591},
	["BloodElf3"] = {hello = 9635,cantuseyet = 9560,cantuse = 9612,congrats = 0, notarget =9598, cantcarry =9592}
};